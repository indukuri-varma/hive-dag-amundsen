...
def connection_string():
    return 'jdbc:sqlserver://marsanalyticsdevsqlsrv.database.windows.net:1433;database=marsanalyticshivesqldb;trustServerCertificate=true,user="hiveadmin";password="32E4UHkFyB5W25JP!"'
